require "../../../src/cassandra/adapters/crecto"
require "crecto"
...
module Repo
  ...
  config do |conf|
    conf.adapter = Crecto::Adapters::Cassandra
    conf.database = "crystal_cassandra_dbapi_test"
...
class User < Crecto::Model
  schema "users" do
    field :id, ::Cassandra::DBApi::TimeUuid, primary_key: true
    field :name, String
